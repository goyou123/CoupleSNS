...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentViewHolder> {
    ...
    static class CommentViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView SecretCommentdata_profileimg;
        TextView SecretCommentdata_Name,SecretCommentdata_Memo,SecretCommentdata_Date,SecretCommentdata_Reply;
        ...
        public CommentViewHolder(@NonNull View itemView) {
            ...
            SecretCommentdata_profileimg =(ImageView) itemView.findViewById(R.id.SecertCommentdata_profileimg);
            SecretCommentdata_Name =(TextView) itemView.findViewById(R.id.SecertCommentdata_Name);
            SecretCommentdata_Memo =(TextView) itemView.findViewById(R.id.SecertCommentdata_Memo);
            SecretCommentdata_Date =(TextView) itemView.findViewById(R.id.SecertCommentdata_Date);
            SecretCommentdata_Reply =(TextView) itemView.findViewById(R.id.SecertCommentdata_Reply);
    ...
    public int getItemViewType(int position) {
        String getWriter = CommentDataList.get(position).getWriter();
        int i = 0;
        Log.d("스토리 리사이클러뷰 뷰타입 결정", "getItemViewType: " + getWriter);

        if (getWriter.equals("익명")) {
            i = 1;
    ...
    public CommentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType==1){
            //익명
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_secret_commentdata,parent,false);
        }else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_commentdata,parent,false);
    ...
    public void onBindViewHolder(@NonNull final CommentViewHolder holder, final int position) {
        ...
        String commentType = CommentDataList.get(position).getWriter();

        if(commentType.equals("익명")){

            /*익명 게시글 댓글*/
            holder.SecretCommentdata_Memo.setText(CommentDataList.get(position).getMemo());
            holder.SecretCommentdata_Name.setText(CommentDataList.get(position).getWriter());
            ...
            holder.SecretCommentdata_Date.setText(setTime);

            //TODO: 익명 댓글 삭제 하려면 const1 롱클릭 해서 수정/삭제
